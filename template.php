...
/**
 * @file
 * Alfie Theme template.php
 *
 * This is WHERE the magic happens!
 *
*/

function alfie_preprocess(&$vars, $hook) {
	if ($hook == "html") {

		/* Prepare Google Analytics
		 * ------------------------
		*/
		if (theme_get_setting('alfie_google_analytics') &&
			theme_get_setting('alfie_google_analytics_code')) {
			$vars['google_analytics_code'] = (theme_get_setting('alfie_google_analytics_code')!='') ? theme_get_setting('alfie_google_analytics_code') : false;
		} else {
			$vars['google_analytics_code'] = false;
		}
		...
		*/
		...
		if (theme_get_setting('alfie_layout_page')) {
			$vars['page_layout'] = theme_get_setting('alfie_layout_page');
		}

		// Little Utility Variable
		$vars['theme_path'] = base_path() . drupal_get_path('theme', 'alfie');;
	...
	elseif ($hook == "page") {
		...
		*/
		...
		$vars['show_breadcrumbs'] = theme_get_setting('alfie_layout_breadcrumbs');
...
*/
function alfie_preprocess_views_view(&$vars) {
...
function alfie_preprocess_views_view_unformatted(&$vars) {
...
function alfie_menu_tree($variables) {
...
/* Modify Messages Output
 * ----------------------
*/
function alfie_status_messages($variables) {
